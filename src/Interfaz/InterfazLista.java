...
public interface InterfazLista {
    ...
    /**
     * Método para añadir un objeto en una posición de la lista pasada por parámetro
     * 
     * @param i
     * @param o 
     */
    ...
    /**
     * Método que elimina un objeto de una posición de la lista pasada por parámetro
     * 
     * @param i 
     */
